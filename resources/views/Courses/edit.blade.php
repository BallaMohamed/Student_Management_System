           ...
           <div class="card contain" style="width: 700px">
                ...
                <div class="card-body">
			      <form action="/courses/{{$course->id}}" method="POST">
					  ...
					  <div class="form-row">
					    <div class="col">
					      <input type="text" class="form-control" name="name" value="{{$course->name}}" placeholder="Enter Course Full Name"><br />
					    ...
					    <div class="col">
					      <textarea class="form-control" name="description" style="height: 100px" placeholder="Enter Department Descripion">{{$course->description}}</textarea>
					    </div>
					  </div>
					  <br>
					  <div class="form-row">
